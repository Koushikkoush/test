...
class Lead(models.Model):
    ...
    client = models.ForeignKey(Client, related_name='leads', on_delete=models.CASCADE, null=True, blank=True)
    ...
    class Meta:
        ordering = ('created_at',)  # Changed from 'name' to 'created_at'

    def __str__(self):
        return f"Lead for {self.client.name if self.client else self.email}"
